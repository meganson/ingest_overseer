/**
 * Created by megan on 2017-08-21.
 */
...
exports.start = function(){
    var self = this;
    megan.log.notice('start Deeplearning Overseer.....');
...
exports.stop = function(){
    megan.log.notice('pause Deeplearning Overseer.....');
    clearInterval(this._interval);
};

exports.deeplearning = function(){
    megan.log.info('doing deeplearning overseer..');
...
exports.requestSpotInstances = function(){
        ...
        if(!err){   // 프로시져 에러 없음
            if(rows[0][0].result == 0){ // 쿼리 성공
                ...
                if(jobCnt > wInstanceCnt) {
                    // scale up
                    megan.log.notice('Deeplearning Spot Scale Up............');

                    // 가능 서버(m - t)
                    // 대기잡(ts)
                    spotCnt = conf.overseer_v2.deeplearning.max - tInstanceCnt;
                    ...
                    // scale down
                    megan.log.notice('Deeplearning Spot Scale Down............');
    ...
    function fn_describeSpotPriceHistory(callback){
        ...
        var spot = {};
        spot.spotPrice = conf.overseer_v2.deeplearning.price;
    ...
    function fn_createTags(instanceId){
        var tagParams = {
            ...
            Tags: [{
                Key: "Name",
                Value: conf.overseer_v2.deeplearning.tag
            }]
        };
